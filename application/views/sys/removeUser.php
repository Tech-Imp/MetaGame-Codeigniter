          ...
          <div class="panel-heading" role="tab">
               ...
               <div class="panel-body">
                    ...
                    <strong id="userMessage">Unable to comply </strong>
                     ...
                     <div class="row">
                         <div class="col-xs-2"><strong>Team </strong></div>
                         <div class="col-xs-10 col-md-4"><?php echo $groupName;?></div>
                         <div class="col-xs-2"><strong>Assoc. ID</strong></div>
                    ...
                    <div class="collapse" id="deleteAssoc">
                         ...
                         <button class="btn btn-success" type="button" id='permDelete'>Yes, Delete Assoc</button>
                         </div>
                    </div>
               </div>
          </div>         
