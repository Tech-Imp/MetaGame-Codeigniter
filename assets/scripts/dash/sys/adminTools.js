...
(function() {
  ...
  adminTools = (function(superClass) {
    ...
    function adminTools() {
      this.setLocked = bind(this.setLocked, this);
      this.setLogged = bind(this.setLogged, this);
      this.setNorm = bind(this.setNorm, this);
    ...
    adminTools.prototype.setupEvents = function() {
      ...
      $(".normVis").unbind().bind("click", (function(_this) {
        return function(event) {
          ...
          return _this.setNorm($(event.currentTarget).data("id"));
        };
      })(this));
      $(".logVis").unbind().bind("click", (function(_this) {
        return function(event) {
          $(".visAdj").prop("disabled", "disabled");
          return _this.setLogged($(event.currentTarget).data("id"));
        };
      })(this));
      return $(".lockVis").unbind().bind("click", (function(_this) {
        return function(event) {
          $(".visAdj").prop("disabled", "disabled");
          return _this.setLocked($(event.currentTarget).data("id"));
        };
      })(this));
    };
    ...
    adminTools.prototype.setNorm = function(sectId) {
      if (this.debug) {
